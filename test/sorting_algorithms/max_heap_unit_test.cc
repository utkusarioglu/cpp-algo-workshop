...
namespace Heap
{
  namespace MaxHeap
  {
    namespace UnitTests
    {
      ...
      class MaxHeapGetHeadTestFixture
          : public ::testing::TestWithParam<IntVector>
      {
      public:
      ...
      INSTANTIATE_TEST_SUITE_P(
        MaxHeap, MaxHeapGetHeadTestFixture,
        ::testing::Values(
      ...
      TEST_P(MaxHeapGetHeadTestFixture, CorrectHead)
      {
        ...
        int expectedValue =
          param.size() == 0 ? 0 : *std::max_element(param.begin(), param.end());
      ...
      TEST_P(MaxHeapGetHeadTestFixture, PopHead)
      {
        IntVector param = GetParam();
        IntVector expected =
          MaxHeapGetHeadTestFixture::produceSortedParams(param);
